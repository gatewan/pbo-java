 ...
 */
public class dFakir extends javax.swing.JDialog {

    /**
     * Creates new form dFakir
     */
    public dFakir(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Data Jamaah Fakir");

        jButton3.setText("Hapus");

        Tfakir.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null, null},
                {null, null, null, null},
                {null, null, null, null},
        ...
        jScrollPane1.setViewportView(Tfakir);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(dFakir.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                dFakir dialog = new dFakir(new javax.swing.JFrame(), true);
    ...
    private javax.swing.JTable Tfakir;
